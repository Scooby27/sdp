...
public class Move {
	...
	public Position translatePoint(Robot robot, ObjectDetails o) {
		...
		int y = -(o.getCoors().getY()) - (-(robot.getCoors().getY())); // negative y to convert into normal coordinate system
	...
	public int getAngleToBall(Robot robot, Ball b){
		...
		System.out.println("Robot coors: " + robot.getCoors().getX() + " " + robot.getCoors().getY());
		...
		case 0: {
			...
			System.out.println("Angle in degrees : " + Math.toDegrees(angle));
